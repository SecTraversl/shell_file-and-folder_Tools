...
############################################
# SYNOPSIS
# - The "search-filesForStringRecursively" function takes a given Regular Expression pattern and searches for that pattern within files in the current directory and any sub-directories.
#
###########
# NOTES
# - Name:  search-filesForStringRecursively.sh
# - Author:  Travis Logue
...
my_bash_funcs$ search-filesForStringRecursively '^function '
